...
<form action="https://buildingsync.us15.list-manage.com/subscribe/post?u=9c1731d3ac180fbb32ae3741c&amp;id=f6464c55b9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	...
	<h2>Subscribe to the User's Working Group Mailing List</h2>
...
<div id="mc_embed_signup">
<form action="https://buildingsync.us15.list-manage.com/subscribe/post?u=9c1731d3ac180fbb32ae3741c&amp;id=33edfdc40e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<h2>Subscribe to the Developer's Working Group Mailing List</h2>
<div class="indicates-required"><span class="asterisk">*</span> indicates required</div>
<div class="mc-field-group">
	<label for="mce-EMAIL">Email Address  <span class="asterisk">*</span>
</label>
...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_9c1731d3ac180fbb32ae3741c_33edfdc40e" tabindex="-1" value=""></div>
    <div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
    </div>
</form>
</div>
